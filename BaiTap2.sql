...
SELECT * FROM Teaches  WHERE username ='levy' or username ='djw';
...
SELECT title, length(title) AS  'LENGTH(title)' FROM Class;
...
SELECT *FROM Instructor WHERE started_on > date('2022-01-01','start of year','-20 year');
